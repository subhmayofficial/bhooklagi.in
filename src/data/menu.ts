...
export const startingPrices: {
  ...
  { categoryId: "meals",      emoji: "🍱", label: "Combo Meals", from: 119 },
  { categoryId: "burgers",    emoji: "🍔", label: "Burgers",    from: 59 },
  { categoryId: "rolls",      emoji: "🌯", label: "Rolls",      from: 59 },
  { categoryId: "maggi",      emoji: "🍜", label: "Maggi",      from: 49 },
  { categoryId: "fries",      emoji: "🍟", label: "Snacks",     from: 49 },
  { categoryId: "sandwiches", emoji: "🥪", label: "Sandwiches", from: 69 },
  { categoryId: "drinks",     emoji: "🧃", label: "Beverages",  from: 39 },
];
